 ...
 * @author Norman
 */
public class MyOlciPixelOpTest {
    ...
    public void testFindBand() throws Exception {
        ...
        assertEquals("b", MyOlciPixelOp.findWaveBand(product, true, 600, 20));
        assertEquals("h", MyOlciPixelOp.findWaveBand(product, true, 800, 10));
    }
    ...
    public void testFindBand_nothingFound() throws Exception {
        ...
        assertNull(MyOlciPixelOp.findWaveBand(product, false, 400, 40));
        assertNull(MyOlciPixelOp.findWaveBand(product, false, 701, 0.5));
        assertNull(MyOlciPixelOp.findWaveBand(product, false, 901, 0.5));
    }
    ...
    public void testFindBand_nothingFound_2() throws Exception {
        ...
        assertNull(MyOlciPixelOp.findWaveBand(product, false, 600, 10));
    }
